...
import {removeTodo,handleCheckbox,deleteAll} from '../redux/actions'
...
function TodoList() {
  ...
  return (
    <div className="bg-dark border-5 pt-5">
        {countState.map((ele)=><TodoItem ele={ele} removeTodo={removeTodo} handleCheckbox={handleCheckbox} key={ele.id}/>)}
